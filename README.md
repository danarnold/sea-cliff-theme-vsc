...
Sea Cliff Theme is a VS Code theme with a blue tinted dark base, high-contrast pastel syntax, and 3 darkness variants. It supports [semantic highlighting](https://github.com/microsoft/vscode/wiki/Semantic-Highlighting-Overview).
